...
<body>
    ...
    <h3>Sign up form</h3>
    <form action="/welcome" method="POST"><?php echo csrf_field(); ?>
    ...
    <br><select>
        ...
        <br><input type="checkbox" id="indo" name="bahasa" value="indo">
        <label for="indo">Bahasa Indonesia</label><br>
        <input type="checkbox" id="eng" name="bahasa" value="eng">
...
<?php /**PATH C:\Users\auntyxcake\blog\resources\views/register.blade.php ENDPATH**/ ?>